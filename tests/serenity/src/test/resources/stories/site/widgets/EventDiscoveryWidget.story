...
Given open Event Discovery Widget page
When search events by keyword <keyword> on Event Discovery Widget
Then found events contains <keyword> on Event Discovery Widget
Examples:
|keyword|
|ADELE  |
|STING  |
...
Given open Event Discovery Widget page
When set Event Count <value> on Event Discovery Widget
...
Given open Event Discovery Widget page
When set Event Count <setValue> on Event Discovery Widget
Then Event Count value is <actualValue> on Event Discovery Widget
Examples:
...
Then Radius value is <actualValue> on Event Discovery Widget
Examples:
|setValue|actualValue|
|   0    |     1     |
|   1    |     1     |
...
Given open Event Discovery Widget page
And remember all fields on the Event Discovery Widget page
And change values for all possible fields on the Event Discovery Widget page
When click reset button
Then all fields have been reseted to defaults
