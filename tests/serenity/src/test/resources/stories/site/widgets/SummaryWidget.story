...
Scenario: (summary widget) TKMDPA-870 Summary widget check for Getting Started page
Given open Getting Started page
Then Summary widget is shown for Getting Started page

Scenario: (summary widget) TKMDPA-870 Summary widget check for Home page
Given open Home page
Then Summary widget is shown for Home page

Scenario: (summary widget) TKMDPA-870 Summary widget check for API Explorer page
