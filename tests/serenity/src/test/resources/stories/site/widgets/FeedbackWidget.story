...
Scenario: 27_1 (feedback widget tests) Feedback widget check
...
Scenario: 27_2 (feedback widget tests) check of elements of Feedback widget
Given open Tutorials Widgets page
Given Feedback widget elements are not shown
When click Feedback button of Tutorials Widgets page
Then Feedback widget elements are shown

Scenario: 27_3 (feedback widget tests) Feedback widget Close button
Given open Tutorials Widgets page
When click Feedback button of Tutorials Widgets page
Then click close button of Feedback widget
Then Feedback widget is not shown

Scenario: 27_4 (feedback widget tests) Feedback widget error notifications fo NAME field
Given open Tutorials Widgets page
...
Scenario: 27_5 (feedback widget tests) Feedback widget error notifications fo Email field
Given open Tutorials Widgets page
Given click Feedback button of Tutorials Widgets page
...
Scenario: 27_6 (feedback widget tests) Feedback widget error notifications fo Subject field
Given open Tutorials Widgets page
Given click Feedback button of Tutorials Widgets page
When click send button of Feedback widget
Then description error notification is shown for Feedback widget

Scenario: 27_7 (feedback widget tests) Feedback widget error notifications when Name length bigger than 255
Given open Tutorials Widgets page
Given click Feedback button of Tutorials Widgets page
When all fields except Name are populated
...
Scenario: 27_8 (feedback widget tests) Feedback widget error notifications when Description length bigger than 3000
Given open Tutorials Widgets page
Given click Feedback button of Tutorials Widgets page
...
Scenario: 27_9 (feedback widget tests) Feedback widget error notifications when Email is not correct
Given open Tutorials Widgets page
Given click Feedback button of Tutorials Widgets page
When all fields except Email are populated
...
Scenario: 27_10 (feedback widget tests) Feedback widget positive scenario
Given open Tutorials Widgets page
Given click Feedback button of Tutorials Widgets page
When all fields except Name are populated
When Name field is populated with bigger than 255 symbols text
