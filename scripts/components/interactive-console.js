(function(){
    ...
    var consoleUrls = {
        ...
        'event-details-v2': '?req=%7B"resource"%3A"discovery_v2_events_id_get"%2C"params"%3A%7B"query"%3A%7B%7D%2C"template"%3A%7B"id"%3A"1A4ZAZyGkeUYKaO"%2C"format"%3A"json"%7D%2C"headers"%3A%7B%7D%2C"body"%3A%7B"attachmentFormat"%3A"mime"%2C"attachmentContentDisposition"%3A"form-data"%7D%7D%2C"verb"%3A"get"%7D',
        'event-img-v2': '?req=%7B"resource"%3A"discovery_v2_events_id_images_get"%2C"params"%3A%7B"query"%3A%7B%7D%2C"template"%3A%7B"id"%3A"1A4ZAZyGkeUYKaO"%2C"format"%3A"json"%7D%2C"headers"%3A%7B%7D%2C"body"%3A%7B"attachmentFormat"%3A"mime"%2C"attachmentContentDisposition"%3A"form-data"%7D%7D%2C"verb"%3A"get"%7D',
