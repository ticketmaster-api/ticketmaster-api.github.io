...
(function ($) {
  ...
  $.fn.classificationSelector = function (options) {
    var defaults = {},
        ...
        $iconButton = $('<a class="icon" id="get-classification-'+options.selector+'" data-toggle="modal" data-target="#js_ls-modal-classification" />');
...
*/
    ...
    return this.each(function (i) {
      ...
      function init(input) {
        ...
        $('#get-classification-'+options.selector+'').on('click', changeModalTextListener);
        tagsIds[selector] = [];
      }
    });
...
$(document).on('ready', function () {
  //$('.js_lazy-selector').classificationSelector({selector:'', hideMultiSelector:true});
...
$(document).on( "finishInit", function( event, flag ) {
  $('#classificationName').classificationSelector({selector:'classification'});
  // $('#classificationId').classificationSelector({selector:'classification'});
  // $('#classificationId').classificationSelector({selector:'attractions'});
});
