...
{% capture Discovery_API_link %}/products-and-docs/apis/discovery/v2/{% endcapture %}
...
<img src="{{Commerce_API}}" alt="{{Commerce_API_title}}"/>
...
<img src="{{OAuth_API}}" alt="{{OAuth_API_title}}"/>
<h3 class="flipper-title hidden-lg">{{OAuth_API_description}}</h3>
</a>
</div>
</div>
<div class="back">
