...
/* WEBPACK VAR INJECTION */(function(process, global, setImmediate) {if (window.ActiveXObject || "ActiveXObject" in window) {
...
class TicketmasterCalendarWidget {
    ...
    get widgetVersion() { return `1.0.0.${4}`; }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(1), __webpack_require__(2).setImmediate))
