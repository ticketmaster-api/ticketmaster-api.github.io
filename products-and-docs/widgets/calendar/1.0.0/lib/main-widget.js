...
var WeekScheduler = function () {
    _createClass(WeekScheduler, [{
        ...
        value: function getWeekEventsHandler() {
            ...
            if (this && this.readyState == XMLHttpRequest.DONE) {
                if (this.status == 200) {
                    ...
                    var tTime = weekEvents[0].time.substring(0, 2);
                    var count = 0;
                    var startFlag = 0;
                    var endFlag = 0;
                    ...
                    if (document.querySelector('[w-type="calendar"]').getAttribute("w-period") != 'week') {
                        var weekstartTmp = new Date(document.querySelector('[w-type="calendar"]').getAttribute("w-period"));
                        var weekstart = weekstartTmp.getDate() - weekstartTmp.getDay();
                    } else {
                    ...
                    for (var _i6 = 0; _i6 <= 6; _i6++) {
                        var day = new Date(new Date(currentSunday).getTime() + _i6 * 24 * 60 * 60 * 1000);
                        if (day.getDay() == now.getDay()) currentDayClass = ' active';else currentDayClass = '';
                        daysDiv += "<span class=\"d" + currentDayClass + "\">" + dayOfWeek[_i6] + " <span class=\"num\">" + day.getDate() + "</span></span>";
                    }
                    var zeroLead = '';
                    var timeTmp = '';
                    var dateTmp = '';
                    ...
                    for (var _i7 = 13; _i7 <= 23; _i7++) {
                        ...
                        timeDiv += "<div class=\"t t-" + _i7 + "\"><span class=\"tl\">" + zeroLead + _i7 + " : 00</span>";
                        ...
                        for (var d = 0; d <= 6; d++) {
                            ...
                            timeDiv += "<div class=\"d d-" + d + "\" w-date=\"" + dateTmp + "\" w-time=\"" + zeroLead + _i7 + ":00:00\">";
        ...
        key: "update",
        value: function update() {
            var days = document.getElementById('weekSсheduler').firstChild;
    ...
    function WeekScheduler(root) {
        ...
        var leftSelector1 = new SelectorControls(document.getElementsByClassName('tab')[1], 'sliderLeftSelector', this.getCurrentMonth(), 'period', this.update.bind(this));
        var RightSelector1 = new SelectorControls(document.getElementsByClassName('tab')[1], 'sliderRightSelector', '<span class="selector-title">All Events</span><span class="selector-content" tabindex="-1"><span class="active" w-classificationId="">All Events</span><span w-classificationId="KZFzniwnSyZfZ7v7na">Arts & Theatre</span><span w-classificationId="KZFzniwnSyZfZ7v7nn">Film</span><span w-classificationId="KZFzniwnSyZfZ7v7n1">Miscellaneous</span><span w-classificationId="KZFzniwnSyZfZ7v7nJ">Music</span><span w-classificationId="KZFzniwnSyZfZ7v7nE">Sports</span></span>', 'classificationId', this.update.bind(this));
...
var MonthScheduler = function () {
    _createClass(MonthScheduler, [{
        ...
        key: "update",
        value: function update() {
            var month = document.getElementById('monthScheduler').firstChild;
    ...
    function MonthScheduler(root) {
        ...
        var leftSelector = new SelectorControls(document.getElementsByClassName('tab')[2], 'sliderLeftSelector', this.getMonthes(), 'period', this.update.bind(this));
        var RightSelector = new SelectorControls(document.getElementsByClassName('tab')[2], 'sliderRightSelector', '<span class="selector-title">All Events</span><span class="selector-content" tabindex="-1"><span class="active" w-classificationId="">All Events</span><span w-classificationId="KZFzniwnSyZfZ7v7na">Arts & Theatre</span><span w-classificationId="KZFzniwnSyZfZ7v7nn">Film</span><span w-classificationId="KZFzniwnSyZfZ7v7n1">Miscellaneous</span><span w-classificationId="KZFzniwnSyZfZ7v7nJ">Music</span><span w-classificationId="KZFzniwnSyZfZ7v7nE">Sports</span></span>', 'classificationId', this.update.bind(this));
...
var monthScheduler = new MonthScheduler(document.getElementById('monthScheduler'));
