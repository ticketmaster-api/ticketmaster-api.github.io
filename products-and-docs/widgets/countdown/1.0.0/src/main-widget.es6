...
class TicketmasterCountdownWidget {
  ...
  get apiUrl(){ return this.config.id ? `https://app.ticketmaster.com/discovery/v2/events/${this.eventId}.json` : `https://app.ticketmaster.com/discovery/v2/events/${this.config.id}.json`; }
